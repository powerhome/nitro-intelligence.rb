  ...
  module Client
    module Handlers
      ...
      private
        ...
        # from - including the binary `StringIO` speech returns, since openai 0.86.
        # The client leaves it unset on nested and locally constructed models, so both
        # the method and its value are optional.
